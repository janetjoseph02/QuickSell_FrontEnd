...
import backlogIcon from "../assets/back.svg";
import cancelIcon from "../assets/cancel-button.svg";
...
const priorityIcons = {
  4: (
    <Tooltip title={priorityLabels[4]} followCursor>
      ...
      <SdCardAlertIcon
          style={{ fontSize: "15px", padding: "0.3rem 0.3rem 0.1rem 0.3rem",color:"black" }}
        />
      </Paper>
    </Tooltip>
  ),
  3: (
    <Tooltip title={priorityLabels[3]} followCursor>
      <Paper style={{ marginRight: "0.5rem", display: "inline-block" }}>
  ...
  0: (
    <Tooltip title={priorityLabels[0]} followCursor>
      <Paper style={{ marginRight: "0.5rem", display: "inline-block" }}>
        <MoreHorizIcon
          style={{ fontSize: "20px", padding: "0.3rem 0.3rem 0.1rem 0.3rem" }}
        />
      </Paper>
    </Tooltip>
  ),
